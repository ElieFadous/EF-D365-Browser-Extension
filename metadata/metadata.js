/**
 * EF Power Platform Tools — Metadata Browser
 *
 * Standalone full-page D365 entity metadata explorer.
 *
 * Authentication: a hidden "proxy tab" is opened on the target environment
 * via the service worker. All D365 Web API calls are then made by injecting
 * fetch calls into that same-origin tab — no CORS issues, full session auth.
 */
 ...
 * In standalone-tab mode: direct credentialed fetch (no proxy tab needed).
